...
class listmap {
   ...
   private:
      ...
      //node* canchor() const { return static_cast<node*> (&canchor_); }
      link anchor_ {anchor(), anchor()};
      //link canchor_ {canchor(), canchor()};
   public:
      class iterator;
      listmap(){};
      ...
      //iterator cbegin() const { return canchor()->next; }
      //iterator cend() const { return canchor(); }
