...
class inode_state {
   ...
   public:
	  inode_ptr getCwd();
	  inode_ptr getRoot();
	  void setCwdTo(inode_ptr ptr);
	  void setCwdToRoot();
      inode_state();
	  void changePrompt(const wordvec& words);
	  const string& spitPrompt();
};
...
class inode {
   ...
   public:
	  ...
	  const file_base_ptr& get_contents();
	  size_t get_size();
	  inode_t get_type();
...
class directory: public file_base {
   ...
   public:
	  ...
	  void setDot(inode_ptr ptr);
	  void setDotDot(inode_ptr ptr);
};
